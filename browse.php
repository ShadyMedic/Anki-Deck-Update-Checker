...
$accessKey = null;
$query = 'SELECT package_id,filename,version,updated_at FROM package WHERE access_key IS NULL;';
...
<body>
    ...
    <article>
        ...
        <table>
            <tr><th class="txt-l">Deck name</th><th>Version number</th><th>Last updated at</th></tr>
            <?php foreach ($packages as $package) : ?>
                <tr>
                    <td class="txt-l"><a href="/deck.php?id=<?= $package['package_id'] ?>"><?= $package['filename'] ?></a></td>
