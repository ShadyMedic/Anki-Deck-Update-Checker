window.addEventListener('load', function() {
    ...
    document.getElementById("reopen-guide-button").onclick = function(event) {
        event.preventDefault();
        ...
        document.getElementById("code-insert-tutorial").style.display = "none";
        document.getElementById("file-input-fieldset").style.display = "none";
        document.getElementById("link-input-fieldset").style.display = "none";
        document.getElementById("remote-input-fieldset").style.display = "none";
        document.getElementById("local-footer").style.display = "none";
        document.getElementById("remote-footer").style.display = "none";
    }
});